...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        EmployeeService employeeServiceBean = applicationContext.getBean(EmployeeService.COMPONENT_NAME, EmployeeService.class);

        System.out.println(employeeServiceBean);

        List<Employee> allEmployees = employeeServiceBean.getAllEmployees();
